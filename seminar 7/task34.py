...
# слов, то они разделяются дефисами. Фразы отделяются друг от друга 
...
phrase = input("Введите фразы Винни-Пуха через пробел : ")
str = phrase.lower().split()
fun = lambda x: sum(1 for i in x if i in 'аеёиоуыэюя')
tr = fun(str[0])
if all([fun(i) == tr for i in str]):
    print('Парам пам-пам')
else:
    print('Пам парам')